...
Senior Python Backend Developer с 5+ годами коммерческого опыта в проектировании и разработке высоконагруженных backend и AI-систем (300-500 RPS), а также построения масштабируемых ETL-систем для обработки миллионов записей.

🚀 Основные результаты:

- 🤖 Создал масштабируемую и стабильную backend-систему, спроектировав и реализовав архитектуру коммерческой AI-платформы с единым слоем доступа к нескольким LLM, обслуживающую 500 000+ пользователей, ~60 RPS в среднем и пики до 300–500 RPS (FastAPI).

- 📁 Построил масштабируемый ETL-процесс для коммерческого AdTech-продукта, обеспечив сбор, обработку и загрузку миллионов записей из VK и Telegram для дальнейшей аналитики и использования в продукте (Selenium, Scrapy).

- 🧠 Инициировал и возглавил разработку AI-платформы для персонализированного планирования тренировок и питания, устранив отсутствие гибкой и масштабируемой архитектуры для персонализации контента, взяв на себя ответственность за backend- и frontend-архитектуру, ключевые технические решения и интеграцию LLM в продукт (Django, React).

- 📘 Получил диплом backend-разработчика на Python (внесён в Федеральный реестр сведений об образовании).

Мне нравится собирать системы, которые работают стабильно и выдерживают нагрузку, разворачивать инфраструктуру, интегрировать новые технологии и оптимизировать всё, до чего могу дотянуться. Многие мои проекты находятся в приватных репозиториях из-за NDA. На GitHub выложена витринная версия одного из крупнейших проектов, над которым я работал последние годы.
