...
- 🤖 Создал масштабируемую и стабильную backend-систему (FastAPI), спроектировав и реализовав архитектуру коммерческой AI-платформы с единым слоем доступа к нескольким LLM, обслуживающую 500 000+ пользователей, ~60 RPS в среднем и пики до 300–500 RPS.
